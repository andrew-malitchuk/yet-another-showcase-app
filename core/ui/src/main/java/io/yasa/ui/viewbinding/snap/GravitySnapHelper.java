package io.yasa.ui.viewbinding.snap;
...
public class GravitySnapHelper extends LinearSnapHelper {
    ...
    /**
     * Enable snapping of the last item that's snappable. The default value is false, because you
     * can't see the last item completely if this is enabled.
     *
    ...
    private View findStartView(RecyclerView.LayoutManager layoutManager, OrientationHelper helper) {
        ...
        if (layoutManager instanceof LinearLayoutManager) {
            ...
            if (mIsRtlHorizontal) {
                visibleWidth =
                        (float) (helper.getTotalSpace() - helper.getDecoratedStart(child))
                                / helper.getDecoratedMeasurement(child);
            } else {
                visibleWidth =
                        (float) helper.getDecoratedEnd(child)
                                / helper.getDecoratedMeasurement(child);
            }
