...
package io.yasa.ui.viewbinding
...
@Deprecated(
    ...
    ReplaceWith("viewBinding(viewBinder)", "io.yasa.ui.viewbinding.viewBindingActivity")
)
...
@Deprecated(
    "Use viewBinding delegate",
    ReplaceWith("viewBinding(vbFactory, viewProvider)", "io.yasa.ui.viewbinding.viewBindingActivity")
)
...
@Deprecated(
    "Use viewBinding delegate",
    ReplaceWith("viewBinding(vbFactory, viewBindingRootId)", "io.yasa.ui.viewbinding.viewBindingActivity"),
)
